...
cor.test(c(1,3,5,7), c(1,3,5,4), method="pearson")
cor.test(c(1,3,5,7), c(1,3,5,4), method='spearman')
cor.test(c(1,3,5,7), c(1,3,5,4), method='kendal')

#### Matrix of correlations with significance levels
# Tip: usually, correlations that considered should be statistically significant.
