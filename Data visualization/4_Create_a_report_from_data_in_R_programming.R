...
# Download used data: https://github.com/Azad77/py4researchers/blob/main/data/LAI_factors.csv
# https://github.com/Azad77/py4researchers/blob/main/data/Countries_LAI_and_LST.csv) 
#### Read in dataset
